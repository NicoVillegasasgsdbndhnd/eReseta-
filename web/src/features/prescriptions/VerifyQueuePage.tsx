          ...
          {queue.map((rx) => {
            ...
            return (
              <div
                ...
                style={{
                  border: `1px solid ${isPending ? 'hsl(45 90% 85%)' : 'hsl(168 50% 80%)'}`,
                }}
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span
                        className={`text-xs font-semibold px-2 py-0.5 rounded-full ${isPending ? 'bg-amber-50 text-amber-700' : 'bg-teal-50 text-teal-700'}`}
                      >
                        {isPending ? (
                  ...
                  <div className="flex flex-col gap-2 shrink-0">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 text-xs text-white font-semibold px-3 py-1.5 rounded-lg transition-colors bg-teal-600 hover:bg-teal-700"
                    >
                      <ShieldCheck size={12} />
